...
```
where return `false` if our critical data has not been received, "to indicate that you don't want anything rendered," to quote the <a href="https://facebook.github.io/react/docs/component-specs.html">docs.</a>
